function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>
        Victor Martin le informa sobre su Política de Privacidad respecto del
        ...
        contratación de servicios a través del sitio Web Emotions and Task.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Principio de minimización de datos: El Titular tratará siempre los
          datos personales de manera lícita, transparente y correcta, con el
          objetivo de garantizar la máxima seguridad y confidencialidad.
        </li>
        <li>
          Principio de limitación de responsabilidad: El Titular se compromete a
          no tratar tus datos personales con fines que no sean los previstos en
      ...
      <p>
        El sitio Web está alojado en Github Pages. La seguridad de tus datos
        está garantizada, ya que toman todas las medidas de seguridad necesarias
